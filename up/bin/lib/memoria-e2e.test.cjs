 ...
 * percorre o fluxo.
 *
 * Tarefa 1 (esta): jornada do criterio 3 do briefing, em um unico caso encadeado
 * (criacao preguicosa, gate das tres condicoes, numeracao crescente). A tarefa 2
 * acrescenta a jornada do criterio 4 (reproposta de conceito recusado) ao mesmo
 * projeto temporario, sem recriar nada.
 */
